...
$obj = formFetch("ess_english", $_GET["id"]); ?>
<script>
...
<form method=post action="<?php echo $rootdir;?>/forms/ess_english/save.php?mode=update&id=<?php echo attr_url($_GET["id"]); ?>" name="my_form" >
