...
<head>
    <title><?php echo xlt('MesCoBraD Tracker Report'); ?></title>
...
<?php } else { ?>
<span class='title'><?php echo xlt('MesCoBraD Tracker Report'); ?></span>
<?php } ?>
...
<form method='post' name='theform' id='theform' action='MesCoBraD_tracker.php' onsubmit='return top.restoreSession()'>
...
<table class='table'>
    ...
    <?php if (!$chk_show_drug_screens && !$chk_show_completed_drug_screens) { # the first part of this block is for the report ?>
    ...
    <tr bgcolor='<?php echo attr($bgcolor ?? ''); ?>'>
        <?php
        if (!$chk_show_drug_screens && !$chk_show_completed_drug_screens) { # the first part of this block is for the MesCoBraD Tracker Report ?>
